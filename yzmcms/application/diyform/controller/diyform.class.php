	 ...
	 */
 	public function add() {
 		if(isset($_POST['dosubmit'])) {
			...
			'sendmail'=> intval($_POST['sendmail']), 'allowvisitor'=>intval($_POST['allowvisitor'])));
			$_POST['type'] = 1;
 	...
 	public function edit() {
		...
		if(isset($_POST['dosubmit'])) {
			...
			$data = array('name'=>$_POST["name"],
				...
				'setting'=>json_encode(array('show_template'=>$_POST['show_template'], 'sendmail'=> intval($_POST['sendmail']), 'allowvisitor'=>intval($_POST['allowvisitor'])))
			);
