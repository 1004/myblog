...
INSERT INTO `yzm_article` VALUES ('2', '2', '1', 'yzmcms', '管理员', 'YzmCMS v3.7正式版开发完成，欢迎大家下载', 'YzmCMS v3.7正式版开发完成，欢迎大家下载_YzmCMS - 演示站', '1520007080', '1520007080', '', 'YzmCMS v3.7正式版终于开发完成，欢迎大家下载。新版增加了自定义表单功能，并添加了几个较常用的标签...', '120', '<p>YzmCMS v3.7正式版终于开发完成，欢迎大家下载。</p><p>新版增加了自定义表单功能，并添加了几个较常用的标签...YzmCMS可以让您不需要任何专业技术轻松搭建您需要的网站，操作简单，很容易上手，快捷方便的后台操作让您10分钟就会建立自己的爱站。在同类产品的比较中，ta更是凸显出了体积轻巧、功能强大、源码简洁、系统安全等特点，无论你是做企业网站、新闻网站、个人博客、门户网站、行业网站等，它都能完全胜任，而且还提供了非常方便的二次开发体系，是一款全能型的建站系统！推荐大家下载更新。</p><p><br/></p><p>本系统采用OOP方式自主开发的框架（YZMPHP），源码简洁、严谨、安全、高效，作者注重优化每一行代码、减少冗余，在保持高效、强大的功能上，同时尽可能减少整体的容量。</p><p><br/></p><p>如果您在使用的过程中发现问题，欢迎大家及时反馈。</p><p><br/></p><p>官方QQ群：161208398</p>', '原创', 'http://blog.yzmcms.com/uploads/thumbnail/20161020105837961.png', '', '/guanfangxinwen/2.html', '1,3', '1', '1', '1', '0', '0');
...
INSERT INTO `yzm_config` VALUES ('39', 'wx_appid', '4', '微信开发者ID', '', '1');
INSERT INTO `yzm_config` VALUES ('40', 'wx_secret', '4', '微信开发者密码', '', '1');
INSERT INTO `yzm_config` VALUES ('41', 'wx_token', '4', '微信Token签名', '', '1');
INSERT INTO `yzm_config` VALUES ('42', 'wx_encodingaeskey', '4', '微信EncodingAESKey', '', '1');
INSERT INTO `yzm_config` VALUES ('43', 'wx_relation_model', '4', '微信关联模型', 'article', '1');
INSERT INTO `yzm_config` VALUES ('44', 'advertise', '99', '首页广告位', '免费又好用的CMS建站系统，就选YzmCMS!', '0');
...
INSERT INTO `yzm_menu` VALUES ('275', '删除广告', '262', 'advertisement', 'adver', 'del', '', '0', '0');
