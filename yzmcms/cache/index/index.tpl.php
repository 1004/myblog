  ...
  <body>
	   <?php include template("index","header"); ?> 
		  ...
		  <div class="right">
			  <div class="right_top">
		         <h2 class="ind_bt"><a target="_blank" href="http://www.yzmcms.com/" class="gengduo">更多>></a>站点介绍</h2>
				  ...
				  <a href="http://www.yzmcms.com/" target="_blank" class="ptitle">本站为YzmCMS的演示站点</a>
			  ...
			  <div class="right_bottom">
                  ...
                  <p class="pic_p"><?php echo page_content(4, 145);?><a href="http://blog.yzmcms.com/guanyu/" target="_blank">[详细]</a></p>
				  <!-- 
		...
		<div id="links">
			<p>友情链接：</p>
			 <ul>
			<?php $tag = yzm_base::load_sys_class('yzm_tag');if(method_exists($tag, 'link')) {$data = $tag->link(array('field'=>'url,logo,name','order'=>'listorder ASC','limit'=>'20',));}?>
			<?php if(is_array($data)) foreach($data as $v) { ?>
