...
$(function(){
	...
	var menu = [{"id":"1","name":"主菜单","parentId":"0","url":"","icon":"","order":"1","isHeader":"1","childMenus":[
					{"id":"3","name":"管理员管理","parentId":"1","url":"","icon":"&#xe604;","order":"1","isHeader":"0","childMenus":[
						{"id":"4","name":"管理员列表","parentId":"3","url":"index.php?p=admin&c=OperationUser&a=userlist","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"5","name":"查询用户","parentId":"3","url":"index.php?p=admin&c=OperationUser&a=searchuser","icon":"","order":"1","isHeader":"0","childMenus":""}
					]},
					{"id":"6","name":"代码管理","parentId":"1","url":"","icon":"&#xe604;","order":"1","isHeader":"0","childMenus":[
						{"id":"7","name":"android代码","parentId":"6","url":"","icon":"","order":"1","isHeader":"0","childMenus":[
                            {"id":"8","name":"分类管理","parentId":"7","url":"index.php?p=admin&c=category&a=showandroid","icon":"","order":"1","isHeader":"0","childMenus":""},
                            {"id":"9","name":"代码管理","parentId":"7","url":"index.php?p=admin&c=OperationUser&a=searchuser","icon":"","order":"1","isHeader":"0","childMenus":""},
                        ]},
						{"id":"10","name":"前端代码","parentId":"6","url":"","icon":"","order":"1","isHeader":"0","childMenus":[
                            {"id":"11","name":"分类管理","parentId":"10","url":"index.php?p=admin&c=OperationUser&a=searchuser","icon":"","order":"1","isHeader":"0","childMenus":""},
                            {"id":"12","name":"代码管理","parentId":"10","url":"index.php?p=admin&c=OperationUser&a=searchuser","icon":"","order":"1","isHeader":"0","childMenus":""},
                        ]}
					]}
				]},
				];
